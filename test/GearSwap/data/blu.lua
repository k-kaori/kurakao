...
--分類
    ...
    sword_cycle = 1
    sets.weapon.almace = {main="ネイグリング", name="タンモガイ+1", augments={'Path: A',},}
    sets.weapon.tizona = {main="ネイグリング", name="タンモガイ+1", augments={'Path: A',},}
    sets.weapon.sequence = {main="ネイグリング", name="タンモガイ+1", augments={'Path: A',},}
