...
--分類
    ...
    sword_cycle = 1
    sets.weapon.almace = {main="ネイグリング", name="サクパタソード"}
    sets.weapon.tizona = {main="ネイグリング", name="サクパタソード"}
    sets.weapon.sequence = {main="ネイグリング", name="サクパタソード"}
    sets.weapon.magic = {main="サクパタソード", sub="マクセンチアス"}
    ...
    back={ name="ロスメルタケープ", augments={'DEX+20','Accuracy+20 Attack+20','"Store TP"+10',}},
    }

    sets.precast.fc = {
	    ammo={ name="ガストリタスラム+1", augments={'Path: A',}},
	    head={ name="ヘルクリアヘルム", augments={'Mag. Acc.+17 "Mag.Atk.Bns."+17','STR+1','Mag. Acc.+5','"Mag.Atk.Bns."+15',}},
	    body={ name="サムヌーハコート", augments={'Mag. Acc.+14','"Mag.Atk.Bns."+13','"Fast Cast"+4','"Dual Wield"+3',}},
    ...
    sets.precast.ws.magic = {
        ...
        body="ＡＳジュバ+2",
        hands="ジャリカフス+2",
        legs={ name="ＬＬシャルワー+2", augments={'Enhances "Assimilation" effect',}},
        feet="ジャリピガッシュ+2",
        neck="サンクトネックレス",
    }
    ...
    send_command('input /macro book 16; wait 0.5; input /macro set 1; wait 0.5; input /si blu;')
end
...
function midcast(spell)
    ...
    if spell.type == 'BlueMagic' then
        ...
        elseif blue_magic[spell.name].type == "magic_atk_earth" then
            set_equip = set_combine(sets.midcast.magic, {hands="ＨＳバズバンド+2", neck="クアンプネックレス",})
        end
    ...
    if buffactive["ディフュージョン"] then
        set_equip = set_combine(set_equip, {feet={ name="ＬＬチャルク+2", augments={'Enhances "Diffusion" effect',}},})
    end
